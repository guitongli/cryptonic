...
import { Search, Bell, Menu, User, ChevronDown, Activity, Zap } from 'lucide-react';
    ...
    <header className="h-16 border-b border-white/10 bg-black/40 backdrop-blur-md flex items-center justify-between px-6 sticky top-0 z-50">
      <div className="flex items-center gap-8">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold tracking-tight text-white">QUANT<span className="text-blue-500">FLOW</span></span>
        </div>
      ...
      <div className="flex-1 max-w-md mx-12 hidden lg:block">
        <div className="relative group">
          ...
          <input 
            type="text" 
            placeholder="Search assets, indicators, or traders..." 
      ...
      <div className="flex items-center gap-6">
        <div className="hidden sm:flex flex-col items-end">
          <div className="text-xs text-white/40 uppercase tracking-wider font-semibold">BTC / USDT</div>
          <div className="flex items-center gap-2">
            <span className="text-sm font-mono text-white">${currentPrice.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
